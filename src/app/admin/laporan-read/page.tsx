        ...
        <div>
            <nav>
                <Link
                    ...
                    <p className='text-[16pt] self-center font-medium schedulesection-text'>Read Laporan</p>
                </Link>
            </nav>
                        ...
                        <div key={laporan.id}>
                            <div
                                className={`px-[10%] flex flex-row place-items-center justify-between py-2.5 ${
                                      lab === 'RPL_1' ? 'lab1-header lab1-text'
                                    : lab === 'RPL_2' ? 'lab2-header lab2-text'
                            ...
                            <div
                                className={`px-[10%] py-4 grid grid-cols-1 gap-2 border-b-1 ${
                                      lab === 'RPL_1' ? 'lab1-bg lab1-text lab1-border'
                                    : lab === 'RPL_2' ? 'lab2-bg lab2-text lab2-border'
                                ...
                                <div className='w-full h-30 relative cursor-pointer' onClick={() => setSelectedImage(laporan.foto_ruangan)}>
                                    <Image
                                ...
                                {laporan.foto_kerusakan && (
                                    <div className='w-full h-30 relative cursor-pointer' onClick={() => setSelectedImage(laporan.foto_kerusakan!)}>
                                        <Image
